...
public class IFSutroFilter extends IFImageFilter {
    ...
    private void setRes() {
        ...
        addInputTexture(R.drawable.filter_sutro_metal);
        addInputTexture(R.drawable.filter_soft_light);
        addInputTexture(R.drawable.filter_sutro_edge_burn);
        addInputTexture(R.drawable.filter_sutro_curves);
    }
}
