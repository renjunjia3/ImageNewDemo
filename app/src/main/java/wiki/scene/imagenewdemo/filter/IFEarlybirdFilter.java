...
public class IFEarlybirdFilter extends IFImageFilter {
    ...
    private void setRes() {
        addInputTexture(R.drawable.filter_earlybird_curves);
        addInputTexture(R.drawable.filter_earlybird_overlay_map);
        addInputTexture(R.drawable.filter_vignette_map);
        addInputTexture(R.drawable.filter_earlybird_blowout);
        addInputTexture(R.drawable.filter_earlybird_map);
    }
}
