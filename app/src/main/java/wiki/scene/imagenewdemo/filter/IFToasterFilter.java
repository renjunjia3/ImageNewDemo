package wiki.scene.imagenewdemo.filter;
...
public class IFToasterFilter extends IFImageFilter {
    ...
    private void setRes() {
        addInputTexture(R.drawable.filter_toaster_metal);
        addInputTexture(R.drawable.filter_toaster_soft_light);
        addInputTexture(R.drawable.filter_toaster_curves);
        addInputTexture(R.drawable.filter_toaster_overlay_map_warm);
        addInputTexture(R.drawable.filter_toaster_color_shift);
    }
}
