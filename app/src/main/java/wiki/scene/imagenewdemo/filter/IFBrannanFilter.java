...
public class IFBrannanFilter extends IFImageFilter {
    ...
    private void setRes() {
        addInputTexture(R.drawable.filter_brannan_process);
        addInputTexture(R.drawable.filter_brannan_blowout);
        addInputTexture(R.drawable.filter_brannan_contrast);
        addInputTexture(R.drawable.filter_brannan_luma);
        addInputTexture(R.drawable.filter_brannan_screen);
    }
}
