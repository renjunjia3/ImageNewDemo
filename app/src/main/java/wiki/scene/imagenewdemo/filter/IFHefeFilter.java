...
public class IFHefeFilter extends IFImageFilter {
    ...
    private void setRes() {
        addInputTexture(R.drawable.filter_edge_burn);
        addInputTexture(R.drawable.filter_hefe_map);
        addInputTexture(R.drawable.filter_hefe_gradient_map);
        addInputTexture(R.drawable.filter_hefe_soft_light);
        addInputTexture(R.drawable.filter_hefe_metal);
    }
}
