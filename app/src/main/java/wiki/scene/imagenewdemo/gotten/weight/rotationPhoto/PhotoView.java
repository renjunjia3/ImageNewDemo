...
//            float remainder = mDegrees % 90;
            float toDegrees = mDegrees;
//            float remainder=mDegrees;
//            if (remainder > 45)
//                toDegrees += 90;
...
//            mScaleCenter.set(detector.getFocusX(), detector.getFocusY());
    ...
    public Info getInfo() {
        ...
        return new Info(rect, local, mImgRect, mWidgetRect, mScale, mDegrees, mScaleType,mInitImageRect);
    }
